...
import AnaliseVision from '../components/AnaliseVision';
...
const Visitas = () => {
  ...
  const [activeTab, setActiveTab] = useState('lista'); // lista, analise
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Conteúdo da Aba Análise de Fotos */}
        {activeTab === 'analise' && (
          <div>
            <AnaliseVision 
              visitaId={editingVisita?.id || 'nova_visita'}
